...
class BeerStore constructor(
    ...
    fun lastRequestBefore(showId: Long, threshold: TemporalAmount): Boolean {
        return true
        // lastRequestDao.isRequestBefore(Request.SHOW_DETAILS, showId, threshold)
    }

    fun updateLastRequest(showId: Long) = null
        //lastRequestDao.updateLastRequest(Request.SHOW_DETAILS, showId)
